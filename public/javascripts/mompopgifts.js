...
document.body.addEventListener('change', function(e) {
  ...
  document.querySelector(
    '.host-header#account-info'
  ).innerText = `${headerPrefix} information`;

  // Show any fields that apply to the new host type
  var hostInfoRows = document.querySelectorAll('.host-info');
  hostInfoRows.forEach(function(row) {
